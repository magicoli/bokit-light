...
if (!function_exists('user_can')) {
    ...
    function user_can(mixed $ability, mixed $model = null): bool
    {
        ...
        if (!is_string($ability)) {
            throw new InvalidArgumentException('Ability must be string or boolean');
        }
    ...
    function debug_error(string $title, $content, string $type = 'info'): void
    {
        ...
        if (!empty($content)) {
            ...
            if ($content instanceof \Throwable) {
                ...
                echo
                    "<li><strong>Trace:</strong><pre style='overflow-x: auto; max-width: 100%; white-space: pre;'>"
            ...
            elseif (is_array($content)) {
                ...
                foreach ($content as $key => $value) {
                    ...
                    elseif (is_string($value) && preg_match("/\n/", $value)) {
                        echo
                            "<pre style='overflow-x: auto; max-width: 100%; white-space: pre;'>"
