            ...
            ->components([
                Section::make(__('app.rate'))
                    ...
                    ->schema([
                        ...
                        TextInput::make('name')
                            ->label(__('rates.field.name')),

                        TextInput::make('unit_type')
                            ->label(__('rates.field.unit_type')),

                        TextInput::make('coupon_code')
                            ->label(__('rates.field.coupon_code')),
                ...
                Section::make(__('rates.section_pricing'))
                    ...
                    ->schema([
                        ...
                        TextInput::make('calculation_formula')
                            ...
                            ->required()
                            ->helperText(__('rates.allowed_variables').': base, parent_rate, booking_nights, guests, adults, children')
                            ->columnSpanFull(),
                    ]),
