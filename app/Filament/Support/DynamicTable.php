...
class DynamicTable
{
    ...
    public static function statusHeroicon(?string $status): string
    {
        return match ($status) {
            ...
            'cancelled', 'cancelled_by_owner', 'cancelled_by_guest', 'deleted', 'vanished' => 'heroicon-o-eye-slash',
            'pending' => 'heroicon-o-clock',
            'unavailable' => 'heroicon-o-lock-closed',
            'request', 'inquiry' => 'heroicon-o-question-mark-circle',
    ...
    public static function statusColor(?string $status): string
    {
        return match ($status) {
            ...
            'new' => 'info',
            'pending', 'request', 'inquiry' => 'warning',
            'unavailable' => 'warning',
            'cancelled', 'cancelled_by_owner', 'cancelled_by_guest', 'deleted', 'vanished', 'rejected' => 'danger',
            'disabled' => 'gray',
            'undefined' => 'gray',
            default => 'gray',
        };
