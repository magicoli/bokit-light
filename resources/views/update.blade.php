    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-8">
            <div class="text-center mb-6">
                ...
                <h1 class="text-2xl font-bold text-gray-900 mb-2">Update Required</h1>
                <p class="text-gray-600 text-sm">Database needs to be updated (local mode)</p>
            </div>
            ...
            @if($count > 0)
            <div class="mb-6">
                <h2 class="text-sm font-medium text-gray-700 mb-2">Pending:</h2>
