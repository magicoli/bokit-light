<form id="setupForm" class="space-y-6">
    ...
    <button type="button" onclick="addProperty()" class="w-full py-3 px-4 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-blue-400 hover:text-blue-600 transition-colors">
...
function addProperty() {
    ...
    propertyDiv.className = 'border-2 border-gray-200 rounded-lg p-4 bg-white property-item relative';
    propertyDiv.dataset.propertyId = propertyCount;
    propertyDiv.innerHTML = `
        <button type="button" onclick="removeProperty(this)" class="absolute top-3 right-3 text-gray-400 hover:text-red-600 remove-btn hidden">
        ...
        <div class="space-y-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
                <div>
                    ...
                    <input
                        ...
                        class="property-name w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input
                        ...
                        class="property-slug w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="my-company"
                        required
                    >
                </div>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">
                    Website <span class="text-xs text-gray-500 font-normal">(optional)</span>
                </label>
                <input
                    type="url"
            ...
            <div class="mt-3 space-y-3">
                ...
                <button type="button" onclick="addUnit(${propertyCount})" class="w-full py-2 px-3 border border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-blue-400 hover:text-blue-600 text-sm transition-colors">
...
function addUnit(propertyId) {
    ...
    unitDiv.className = 'border border-gray-200 rounded-lg p-3 bg-gray-50 unit-item relative';
    unitDiv.innerHTML = `
        <button type="button" onclick="removeUnit(this, ${propertyId})" class="absolute top-2 right-2 text-gray-400 hover:text-red-600 unit-remove-btn hidden">
        ...
        <div class="space-y-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-2">
                <div>
                    ...
                    <input
                        ...
                        class="unit-name w-full px-2 py-1.5 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input
                        ...
                        class="unit-slug w-full px-2 py-1.5 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="my-accommodation"
                        required
                    >
                </div>
            ...
            <div class="mt-2 space-y-2">
                ...
                <button type="button" onclick="addIcalSource(${propertyId}, ${unitCount})" class="w-full py-1.5 px-2 border border-dashed border-gray-300 rounded text-gray-600 hover:border-green-400 hover:text-green-600 text-xs transition-colors">
    ...
    sourceDiv.innerHTML = `
        <div class="grid grid-cols-1 lg:grid-cols-[120px_1fr] gap-2 flex-1">
            <select
                ...
                class="px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
            >
        ...
        <button type="button" onclick="removeIcalSource(this, ${propertyId}, ${unitId})" class="text-gray-400 hover:text-red-600 source-remove-btn hidden">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
            </svg>
        </button>
