...
@section('scripts')
<script>
    // Toggle WordPress config visibility
    ...
    noneRadio.addEventListener('change', updateConfigVisibility);
    wordpressRadio.addEventListener('change', updateConfigVisibility);
    ...
    document.getElementById('auth-form').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await fetch('/install/configure-auth', {
                method: 'POST',
                headers: {
