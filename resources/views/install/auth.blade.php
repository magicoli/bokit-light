...
@section('content')
    ...
    <div class="mb-8">
        ...
        <p class="text-secondary text-sm">Choose how users will authenticate to access your calendar.</p>
    </div>
    ...
    <form id="auth-form" class="space-y-6">
        ...
        <div class="space-y-4">
            <label class="block text-sm font-medium text-dark mb-2">Authentication Method</label>
            ...
            <label class="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition" id="none-option">
                ...
                <div class="flex-1">
                    ...
                    <div class="text-sm text-secondary mt-1">Anyone can access the calendar without logging in</div>
            ...
            <label class="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition" id="wordpress-option">
                ...
                <div class="flex-1">
                    ...
                    <div class="text-sm text-secondary mt-1">Authenticate using an existing WordPress site</div>
                </div>
            </label>
        </div>

        <!-- WordPress Configuration (hidden by default) -->
        <div id="wordpress-config" class="hidden space-y-4 pl-7 border-l-4 border-primary">
            <div>
                ...
                >
                <p class="text-xs text-secondary mt-1">The URL of your WordPress site (without trailing slash)</p>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full px-3 py-2 border border-light rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
                >
                <p class="text-xs text-secondary mt-1">WordPress role required to access the calendar (e.g., administrator, administrator)</p>
            </div>
        ...
        <div class="flex justify-end">
            <button
                type="submit"
                id="submit-btn"
                class="bg-primary hover:bg-blue-700 text-white font-bold py-3 px-6 rounded focus:outline-none focus:shadow-outline disabled:opacity-50 disabled:cursor-not-allowed"
            >
