...
describe('Public throttle', function () {
    ...
    test('lets ordinary browsing through', function () {
    ...
    test('answers 429 once the public limit is exceeded', function () {
     ...
     */
    test('logs what was rejected, with enough to judge it', function () {
