...
describe('Booking Title', function () {
    beforeEach(function () {
    ...
    test('builds the one-line title for a single booking', function () {
    ...
    test('omits the guest count when unknown', function () {
        $booking = Booking::create([
            'property_id' => $this->property->id,
            'unit_id' => $this->unit->id,
    ...
    test('aggregates units, guests and the date span for group reservations', function () {
    ...
    test('translates the title in french', function () {
        app()->setLocale('fr');
    ...
    test('expands the range precision across months and years', function (string $in, string $out, string $expected) {
        $booking = Booking::create([
            'property_id' => $this->property->id,
            'unit_id' => $this->unit->id,
