...
describe('Backup', function () {
    test('backs up the database the application actually uses', function () {
    ...
    test('archives what no deploy could rebuild', function () {
    ...
    test('puts the settings and the key in every archive, the uploads only in a full one', function () {
    ...
    test('archives the uploaded files unless told to leave them out', function () {
        Storage::fake('backups');
    ...
    test('answers to the package name and to ours with one and the same command', function () {
    ...
    test('lists both destinations, not only the full ones', function () {
        Storage::fake('backups');
    ...
    test('keeps the two kinds apart, so neither retention touches the other', function () {
    ...
    test('writes each kind to its own destination', function () {
        Storage::fake('backups');
    ...
    test('drops an essential backup once a full one covers it, and keeps the full one for years', function () {
        Storage::fake('backups');
    ...
    test('keeps every backup of the last day, then thins out', function () {
    ...
    test('takes a backup on the first page load past the interval', function () {
        Bus::fake();
    ...
    test('leaves the next visitors alone until the interval has elapsed', function () {
        Bus::fake();
        config(['backup.auto.enabled' => true]);
    ...
    test('takes no backup when the site is not being visited', function () {
    ...
    test('runs the same command an operator would', function () {
        Storage::fake('backups');
