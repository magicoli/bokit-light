...
it('stores the permanent refresh token from the invite-code exchange, not the short-lived token', function () {
    Http::fake([
...
it('refreshes an auth token using the stored refresh token', function () {
    Http::fake([
