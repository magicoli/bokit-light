...
describe('Scanner URLs', function () {
    ...
    test('serves the unit page it is meant to serve', function () {
        $this->get('/mosaiques/moon')->assertSuccessful();
    });

    test('answers 404 when the unit does not belong to the property', function () {
     ...
     */
    test('answers 404 when route binding resolved nothing', function () {
