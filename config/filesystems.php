...
return [
    ...
    'disks' => [
        ...
        // Backups live beside the application data, not inside it: storage/ is shared between
        // releases so they survive a deploy, and storage/app/ is what the backup itself archives.
        'backups' => [
            'driver' => 'local',
    ...
    'links' => [
        public_path('storage') => $public_storage_path,
    ],
];
