...
return [
    ...
    'field.beds24_invite_code_help' => 'Nécessaire pour pousser des réservations vers Beds24 (synchro bidirectionnelle). Générez un code avec le scope « bookings » sur <a href=":url" target="_blank" class="underline">la page API de Beds24</a> et collez-le ici : il sera échangé immédiatement contre un jeton permanent.',
