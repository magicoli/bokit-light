...
return [
    ...
    'field.beds24_invite_code_help' => 'Required to push bookings to Beds24 (bidirectional sync). Generate a code with the "bookings" scope on <a href=":url" target="_blank" class="underline">the Beds24 API page</a> and paste it here: it is exchanged immediately for a permanent token.',
