...
- [ ] Mobile week display overflow, move property/unit small title as additional above the row instead of in a specific column.
- [ ] Some overlapping booking are cut before the border (middle of the day) instead of on the border (Bouquin/Moon/15-01 to 08-02)
